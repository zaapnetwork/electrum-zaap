...
from electrum_zaap_gui.qt.util import *
from .plugin import TIM_NEW, TIM_RECOVER, TIM_MNEMONIC
from ..hw_wallet.qt import QtHandlerBase, QtPluginBase

from electrum_zaap.i18n import _
from electrum_zaap.plugins import hook, DeviceMgr
from electrum_zaap.util import PrintError, UserCancelled
from electrum_zaap.wallet import Wallet, Standard_Wallet

PASSPHRASE_HELP_SHORT =_(
    "Passphrases allow you to access new wallets, each "
    "hidden behind a particular case-sensitive passphrase.")
PASSPHRASE_HELP = PASSPHRASE_HELP_SHORT + "  " + _(
    "You need to create a separate Electrum-zaap wallet for each passphrase "
    "you use as they each generate different addresses.  Changing "
    "your passphrase does not lose other wallets, each is still "
    "accessible behind its own passphrase.")
RECOMMEND_PIN = _(
    "You should enable PIN protection.  Your PIN is the only protection "
    "for your zaap if your device is lost or stolen.")
PASSPHRASE_NOT_PIN = _(
    "If you forget a passphrase you will be unable to access any "
    "zaap in the wallet behind it.  A passphrase is not a PIN. "
    ...
    def request_trezor_init_settings(self, wizard, method, device):
        ...
        if method in [TIM_NEW, TIM_RECOVER]:
            ...
            if method == TIM_MNEMONIC:
                ...
                def set_enabled():
                    from electrum_zaap.keystore import is_xprv
...
class SettingsDialog(WindowModalDialog):
    ...
    def __init__(self, window, plugin, keystore, device_id):
        ...
        def toggle_passphrase():
            ...
            if currently_enabled:
                msg = _("After disabling passphrases, you can only pair this "
                        "Electrum-zaap wallet if it had an empty passphrase.  "
                        "If its passphrase was not empty, you will need to "
                        "create a new wallet with the install wizard.  You "
                        "can use this wallet again at any time by re-enabling "
                        "passphrases and entering its passphrase.")
            else:
                msg = _("Your current Electrum-zaap wallet can only be used with "
        ...
        def wipe_device():
            ...
            if wallet and sum(wallet.get_balance()):
                ...
                msg = _("Are you SURE you want to wipe the device?\n"
                        "Your wallet still has zaap in it!")
                if not self.question(msg, title=title,
        ...
        pin_msg = QLabel(_("PIN protection is strongly recommended.  "
                           ...
                           "stealing your zaap if they obtain physical "
        ...
        clear_pin_warning = QLabel(
            _("If you disable your PIN, anyone with physical access to your "
              "%s device can spend your zaap.") % plugin.device)
        ...
        wipe_device_warning = QLabel(
            _("Only wipe a device if you have the recovery seed written down "
              "and the device wallet(s) are empty, otherwise the zaap "
