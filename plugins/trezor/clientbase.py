...
from electrum_zaap.keystore import bip39_normalize_passphrase
from electrum_zaap.bitcoin import serialize_xpub
    ...
    def callback_PassphraseRequest(self, req):
        if self.creating_wallet:
            msg = _("Enter a passphrase to generate this wallet.  Each time "
                    ...
                    "access the zaap in the wallet.") % self.device
        else:
