...
from electrum_zaap.bitcoin import (TYPE_ADDRESS, int_to_hex, var_int,
...
from electrum_zaap.keystore import Hardware_KeyStore, parse_xpubkey
from electrum_zaap.transaction import push_script, Transaction
from ..hw_wallet import HW_PluginBase
from electrum_zaap.util import format_satoshis_plain, print_error, is_verbose
    ...
    def checkDevice(self):
        if not self.preflightDone:
            try:
                ...
                if (e.sw == 0x6d00):
                    raise BaseException("Device not in zaap mode")
                raise e
