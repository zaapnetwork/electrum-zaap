...
try:
    ...
    from electrum_zaap.bitcoin import TYPE_ADDRESS, var_int, msg_magic, Hash, verify_message, pubkey_from_signature, point_to_ser, public_key_to_p2pkh, EncodeAES, DecodeAES, MyVerifyingKey
    from electrum_zaap.i18n import _
    from electrum_zaap.keystore import Hardware_KeyStore
    from ..hw_wallet import HW_PluginBase
    from electrum_zaap.util import print_error
