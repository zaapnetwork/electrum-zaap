...
pyinstaller \
    -y \
    --name electrum-zaap-$ELECTRUM_zaap_VERSION.bin \
    osx.spec

sudo hdiutil create -fs HFS+ -volname "Electrum-zaap" \
    -srcfolder dist/Electrum-zaap.app \
    dist/electrum-zaap-$ELECTRUM_zaap_VERSION-macosx.dmg
