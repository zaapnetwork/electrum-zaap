...
from electrum_zaap.util import AlreadyHaveAddress, print_error
from electrum_zaap.util import format_satoshis_plain
...
class MasternodeManager(object):
    ...
    def get_masternode_outputs(self, domain = None, exclude_frozen = True):
        ...
        # Valid outputs have a value of exactly 1000 zaap and
    ...
    def check_can_sign_masternode(self, alias):
        ...
        if mn.vin.get('value', 0) != bitcoin.COIN * 1000:
            raise Exception('Masternode requires a collateral 1000 zaap output.')
