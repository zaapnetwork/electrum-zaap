...
class Bittrex(ExchangeBase):
    def get_rates(self, ccy):
        json = self.get_json('bittrex.com',
                             '/api/v1.1/public/getticker?market=BTC-zaap')
        quote_currencies = {}
...
class Poloniex(ExchangeBase):
    def get_rates(self, ccy):
        ...
        quote_currencies = {}
        zaap_ticker = json.get('BTC_zaap')
        quote_currencies['BTC'] = Decimal(zaap_ticker['last'])
        return quote_currencies


class CoinMarketCap(ExchangeBase):
    def get_rates(self, ccy):
        json = self.get_json('api.coinmarketcap.com', '/v1/ticker/zaap/')
        quote_currencies = {}
