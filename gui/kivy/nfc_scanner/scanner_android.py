...
from electrum_zaap_gui.kivy.nfc_scanner import NFCBase
...
class ScannerAndroid(NFCBase):
    ...
    def create_AAR(self):
        ...
        return NdefRecord.createApplicationRecord(
            JString("org.electrum_zaap.electrum_zaap_develop.kivy"))

    def create_TNF_EXTERNAL(self, data):
        '''Create our actual payload record.
        '''
        if BUILDVERSION >= 14:
            domain = "org.electrum_zaap.electrum_zaap_develop"
            stype = "externalType"
            ...
            extRecord = NdefRecord(
                ...
                "org.electrum_zaap_electrum_zaap.electrum_zaap_develop:externalType",
                '',
                data)
        return extRecord
    ...
    def _nfc_enable_ndef_exchange(self, data):
        ...
        ndef_record = NdefRecord(
                ...
                'org.electrum_zaap.electrum_zaap_develop.kivy', '', data)
