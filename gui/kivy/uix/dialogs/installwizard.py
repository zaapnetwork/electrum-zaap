...
from electrum_zaap_gui.kivy.uix.dialogs import EventsDialog
...
class RestoreSeedDialog(WizardDialog):
    ...
    def __init__(self, wizard, **kwargs):
        ...
        from electrum_zaap.mnemonic import Mnemonic
        from electrum_zaap.old_mnemonic import words as old_wordlist
