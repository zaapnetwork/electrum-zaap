...
QComboBox::down-arrow {
    border-image: url(':/icons/zaap_downArrow.png') 0 0 0 0 stretch stretch;
}
...
QScrollBar:up-arrow {
    background-image: url(':/icons/zaap_upArrow_small.png');
}

QScrollBar:down-arrow {
    background-image: url(':/icons/zaap_downArrow_small.png');
}

QScrollBar:left-arrow {
    background-image: url(':/icons/zaap_leftArrow_small.png');
}

QScrollBar:right-arrow {
    background-image: url(':/icons/zaap_rightArrow_small.png');
}
