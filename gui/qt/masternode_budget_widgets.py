...
from electrum_zaap.masternode_budget import BudgetProposal, BudgetVote
from electrum_zaap.masternode_manager import BUDGET_FEE_CONFIRMATIONS
from electrum_zaap.util import block_explorer_URL, print_error, format_satoshis_plain
...
def budget_explorer_url(item_type, identifier):
    ...
    if item_type == 'proposal':
        return 'https://zaapwhale.org/p/%s' % identifier
...
class ProposalsTab(QWidget):
    ...
    def __init__(self, parent):
        ...
        description = ''.join(['You can create a budget proposal below. ',
                'Proposals require 5 zaap to create. ',
        ...
        form.addRow(_('Payment Address:'), self.address_edit)
        form.addRow(_('Monthly zaap Payment:'), self.amount_edit)
