...
from electrum_zaap import bitcoin
from electrum_zaap.bitcoin import COIN
from electrum_zaap.i18n import _
from electrum_zaap.masternode import NetworkAddress, MasternodeAnnounce
...
class PrevOutWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.hash_edit.setPlaceholderText(_('The TxID of your 1000 zaap output'))
        self.index_edit = QLineEdit()
        self.index_edit.setPlaceholderText(_('The output number of your 1000 zaap output'))
        self.address_edit = QLineEdit()
        self.address_edit.setPlaceholderText(_('The address that 1000 zaap was sent to'))
...
class MasternodeEditor(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        form.addRow(_('Collateral zaap Output:'), self.vin_edit)
...
class MasternodeOutputsTab(QWidget):
    ...
    def __init__(self, parent):
        ...
        desc = ' '.join(['Use this tab to scan for and choose a collateral payment for your masternode.',
            'A valid collateral payment is exactly 1000 zaap.'])
        desc = QLabel(_(desc))
    ...
    def scan_for_outputs(self, include_frozen):
        ...
        if len(coins) > 0:
            ...
            self.status_edit.setText(_('No 1000 zaap outputs were found.'))
...
class SignAnnounceWidget(QWidget):
    ...
    def __init__(self, parent):
        ...
        form = QFormLayout()
        form.addRow(_('Alias:'), self.alias_edit)
        form.addRow(_('Collateral zaap Output:'), self.collateral_edit)
