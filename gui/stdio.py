...
from electrum_zaap.util import format_satoshis, set_verbosity
from electrum_zaap.bitcoin import is_valid, COIN, TYPE_ADDRESS
from electrum_zaap.network import filter_protocol
...
class ElectrumGui:
    ...
    def __init__(self, config, daemon, plugins):
        ...
        if not storage.file_exists:
            print "Wallet not found. try 'electrum-zaap create'"
            exit()
    ...
    def network_dialog(self):
        print("use 'electrum-zaap setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-zaap setconfig' to change your settings")
        return True
